<%-- 
    Document   : about
    Created on : 20 Aug, 2022, 5:00:20 PM
    Author     : soura
--%>
...
<html>
    ...
    <body style="background-image: linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.1)),url(aicte_banner.jpg);">
        <%@include file="navbar.jsp" %>
        <div style="border:5px solid black; text-align: center; background-color: white; opacity:0.65">
            
    <h1>About Us</h1>
<p>Hello, Dear friends, Welcome to AICTE also, we are happy you want to know something more about our site</p>
...
<p>If you have additional questions or require more information about our About Us Page, do not hesitate to contact us through email at <b>1234@aicte.com</b></p>
...
<p>Basically, we focus on the Educational  niche so, our main priority is to search for new content and present it in front of you to learn something new. </p>
<h3><b>What is our Service?</b></h3>
<p>We are mainly focused on the Educational  category so, we provide Educational  related content if you are interested in the Educational  category then you can visit daily to get more latest information.</p>
<p>technical education and to promote development in the country in a coordinated and integrated manner.</p>
...
<p>Also, we provide a Notification update service you can join by email and other Social Media Platforms, and all Links you can get on the Homepage visit now. <a href"AICTE.com">AICTE</a></p>
<h3><b>About AICTE</b></h3>
<p>As you can see already we mention what is our goal and Service again we repeat that we mainly focus on Educational  Category to help people.</p>
<p>This Website is Created By AICTE to help people because many people are still spending hours of time to get exact information so, this is the only motive to create <a href"AICTE.com">AICTE</a> to help people and provide them a better web experience. Also, This About Us Page is Generated With <a href="https://soumyahelp.com">Soumya help</a>.</p>
...
<h3><b>Admin's Statement for AICTE</b></h3>
...
<p>Finally, this is our complete about us page about details are showing what is the motive to create AICTE. Also, this page is generated by Soumya Help <a href="https://soumyahelp.com/about-us-generator/">About Us Generator</a></p>
<p>If you want to contact us then you can email us at 1234@aicte.com also, you can contact us by our contact us form. Go to homepage --> <a href="AICTE.com">AICTE</a><a href="https://soumyahelp.com/about-us-generator/">.</a></p>
<center>
